...
public final class FindMeetingQueryTest {
  ...
  public void everyAttendeeIsConsideredIgnoreOptional() {
    // Have two attendees have different events and have an optional attendee have an
    // all-day event. This optional attendee should have no effect on the result.
    //
    // Events  : |--------------C--------------|
    //                 |--A--|     |--B--|
    // Day     : |-----------------------------|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY),
  ...
  public void everyAttendeeIsConsideredOptional() {
    // Have two attendees have different events and have an optional attendee have an
    // event in between the other two events. Only the option before and option after these
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartEnd(TIME_0830AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_C)));
  ...
  public void notEnoughRoomOptional() {
    // Have two optional Attendees with no gaps in their schedule. There should be no
    // options returned.
    //
    // Events  : |-----A----|-----B----|
    // Day     : |---------------------|
  ...
  public void optionalWithGaps() {
    // Have no mandotory attendees. Have two optional attendees with gaps
    // in thier schedule. We should see options between those gaps.
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
